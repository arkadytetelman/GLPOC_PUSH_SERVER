...
import com.globallogic.poc.push_server.utils.Constants;
...
public class Sender {
    ...
    public Result sendNoRetry(Message message, String registrationId)
        ...
        if (delayWhileIdle != null) {
            addParameter(body, Constants.PARAM_DELAY_WHILE_IDLE, delayWhileIdle ? "1"
                    : "0");
        }
            ...
            if (results != null) {
                for (Map<String, Object> jsonResult : results) {
                    ...
                    String canonicalRegId = (String) jsonResult
                            .get(Constants.TOKEN_CANONICAL_REG_ID);
